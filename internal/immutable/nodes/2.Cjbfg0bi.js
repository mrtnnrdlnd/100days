...
`)+`
`+m);const T=E+g+a,u=E+m+o,f=Uh(r,r.VERTEX_SHADER,T),A=Uh(r,r.FRAGMENT_SHADER,u);r.attachShader(S,f),r.attachShader(S,A),e.index0AttributeName!==void 0?r.bindAttribLocation(S,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function I(C){if(n.debug.checkShaderErrors){const G=r.getProgramInfoLog(S)||"",N=r.getShaderInfoLog(f)||"",L=r.getShaderInfoLog(A)||"",B=G.trim(),H=N.trim(),k=L.trim();let W=!0,j=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(W=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,S,f,A);else{const it=Bh(r,f,"vertex"),rt=Bh(r,A,"fragment");be("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`
