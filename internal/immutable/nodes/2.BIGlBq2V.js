...
void main() {
	...
	`}class _p extends Hi{constructor(t=1,e={}){super(t,t,e),this.isWebGLCubeRenderTarget=!0;const i={width:t,height:t,depth:1},r=[i,i,i,i,i,i];this.texture=new hp(r),this._setTextureOptions(e),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(t,e){this.texture.type=e.type,this.texture.colorSpace=e.colorSpace,this.texture.generateMipmaps=e.generateMipmaps,this.texture.minFilter=e.minFilter,this.texture.magFilter=e.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new Wa(5,5,5),s=new Wi({name:"CubemapFromEquirect",uniforms:Js(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:Hn,blending:lr});s.uniforms.tEquirect.value=e;const a=new Jn(r,s),o=e.minFilter;return e.minFilter===Qr&&(e.minFilter=Sn),new my(1,10,this).update(t,a),e.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(t,e=!0,i=!0,r=!0){const s=t.getRenderTarget();for(let a=0;a<6;a++)t.setRenderTarget(this,a),t.clear(e,i,r);t.setRenderTarget(s)}}function cb(n){let t=new WeakMap,e=new WeakMap,i=null;function r(f,m=!1){return f==null?null:m?a(f):s(f)}function s(f){if(f&&f.isTexture){const m=f.mapping;if(m===Zl||m===Xl)if(t.has(f)){const v=t.get(f).texture;return o(v,f.mapping)}else{const v=f.image;if(v&&v.height>0){const b=new _p(v.height);return b.fromEquirectangularTexture(n,f),t.set(f,b),f.addEventListener("dispose",c),o(b.texture,f.mapping)}else return null}}return f}function a(f){if(f&&f.isTexture){const m=f.mapping,v=m===Zl||m===Xl,b=m===is||m===qs;if(v||b){let g=e.get(f);const _=g!==void 0?g.texture.pmremVersion:0;if(f.isRenderTargetTexture&&f.pmremVersion!==_)return i===null&&(i=new wh(n)),g=v?i.fromEquirectangular(f,g):i.fromCubemap(f,g),g.texture.pmremVersion=f.pmremVersion,e.set(f,g),g.texture;if(g!==void 0)return g.texture;{const E=f.image;return v&&E&&E.height>0||b&&E&&l(E)?(i===null&&(i=new wh(n)),g=v?i.fromEquirectangular(f):i.fromCubemap(f),g.texture.pmremVersion=f.pmremVersion,e.set(f,g),f.addEventListener("dispose",d),g.texture):null}}}return f}function o(f,m){return m===Zl?f.mapping=is:m===Xl&&(f.mapping=qs),f}function l(f){let m=0;const v=6;for(let b=0;b<v;b++)f[b]!==void 0&&m++;return m===v}function c(f){const m=f.target;m.removeEventListener("dispose",c);const v=t.get(m);v!==void 0&&(t.delete(m),v.dispose())}function d(f){const m=f.target;m.removeEventListener("dispose",d);const v=e.get(m);v!==void 0&&(e.delete(m),v.dispose())}function p(){t=new WeakMap,e=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:p}}function ub(n){const t={};function e(i){if(t[i]!==void 0)return t[i];const r=n.getExtension(i);return t[i]=r,r}return{has:function(i){return e(i)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(i){const r=e(i);return r===null&&jo("WebGLRenderer: "+i+" extension not supported."),r}}}function db(n,t,e,i){const r={},s=new WeakMap;function a(p){const f=p.target;f.index!==null&&t.remove(f.index);for(const v in f.attributes)t.remove(f.attributes[v]);f.removeEventListener("dispose",a),delete r[f.id];const m=s.get(f);m&&(t.remove(m),s.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function o(p,f){return r[f.id]===!0||(f.addEventListener("dispose",a),r[f.id]=!0,e.memory.geometries++),f}function l(p){const f=p.attributes;for(const m in f)t.update(f[m],n.ARRAY_BUFFER)}function c(p){const f=[],m=p.index,v=p.attributes.position;let b=0;if(v===void 0)return;if(m!==null){const E=m.array;b=m.version;for(let T=0,u=E.length;T<u;T+=3){const h=E[T+0],M=E[T+1],I=E[T+2];f.push(h,M,M,I,I,h)}}else{const E=v.array;b=v.version;for(let T=0,u=E.length/3-1;T<u;T+=3){const h=T+0,M=T+1,I=T+2;f.push(h,M,M,I,I,h)}}const g=new(v.count>=65535?up:cp)(f,1);g.version=b;const _=s.get(p);_&&t.remove(_),s.set(p,g)}function d(p){const f=s.get(p);if(f){const m=p.index;m!==null&&f.version<m.version&&c(p)}else c(p);return s.get(p)}return{get:o,update:l,getWireframeAttribute:d}}function hb(n,t,e){let i;function r(f){i=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function l(f,m){n.drawElements(i,m,s,f*a),e.update(m,i,1)}function c(f,m,v){v!==0&&(n.drawElementsInstanced(i,m,s,f*a,v),e.update(m,i,v))}function d(f,m,v){if(v===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,m,0,s,f,0,v);let g=0;for(let _=0;_<v;_++)g+=m[_];e.update(g,i,1)}function p(f,m,v,b){if(v===0)return;const g=t.get("WEBGL_multi_draw");if(g===null)for(let _=0;_<f.length;_++)c(f[_]/a,m[_],b[_]);else{g.multiDrawElementsInstancedWEBGL(i,m,0,s,f,0,b,0,v);let _=0;for(let E=0;E<v;E++)_+=m[E]*b[E];e.update(_,i,1)}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=d,this.renderMultiDrawInstances=p}function fb(n){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(e.calls++,a){case n.TRIANGLES:e.triangles+=o*(s/3);break;case n.LINES:e.lines+=o*(s/2);break;case n.LINE_STRIP:e.lines+=o*(s-1);break;case n.LINE_LOOP:e.lines+=o*s;break;case n.POINTS:e.points+=o*s;break;default:be("WebGLInfo: Unknown draw mode:",a);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:i}}function pb(n,t,e){const i=new WeakMap,r=new nn;function s(a,o,l){const c=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,p=d!==void 0?d.length:0;let f=i.get(o);if(f===void 0||f.count!==p){let S=function(){I.dispose(),i.delete(o),o.removeEventListener("dispose",S)};f!==void 0&&f.texture.dispose();const m=o.morphAttributes.position!==void 0,v=o.morphAttributes.normal!==void 0,b=o.morphAttributes.color!==void 0,g=o.morphAttributes.position||[],_=o.morphAttributes.normal||[],E=o.morphAttributes.color||[];let T=0;m===!0&&(T=1),v===!0&&(T=2),b===!0&&(T=3);let u=o.attributes.position.count*T,h=1;u>t.maxTextureSize&&(h=Math.ceil(u/t.maxTextureSize),u=t.maxTextureSize);const M=new Float32Array(u*h*4*p),I=new ap(M,u,h,p);I.type=Ui,I.needsUpdate=!0;const y=T*4;for(let O=0;O<p;O++){const C=g[O],G=_[O],N=E[O],L=u*h*4*O;for(let B=0;B<C.count;B++){const H=B*y;m===!0&&(r.fromBufferAttribute(C,B),M[L+H+0]=r.x,M[L+H+1]=r.y,M[L+H+2]=r.z,M[L+H+3]=0),v===!0&&(r.fromBufferAttribute(G,B),M[L+H+4]=r.x,M[L+H+5]=r.y,M[L+H+6]=r.z,M[L+H+7]=0),b===!0&&(r.fromBufferAttribute(N,B),M[L+H+8]=r.x,M[L+H+9]=r.y,M[L+H+10]=r.z,M[L+H+11]=N.itemSize===4?r.w:1)}}f={count:p,texture:I,size:new Ve(u,h)},i.set(o,f),o.addEventListener("dispose",S)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",a.morphTexture,e);else{let m=0;for(let b=0;b<c.length;b++)m+=c[b];const v=o.morphTargetsRelative?1:1-m;l.getUniforms().setValue(n,"morphTargetBaseInfluence",v),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",f.texture,e),l.getUniforms().setValue(n,"morphTargetsTextureSize",f.size)}return{update:s}}function mb(n,t,e,i,r){let s=new WeakMap;function a(c){const d=r.render.frame,p=c.geometry,f=t.get(c,p);if(s.get(f)!==d&&(t.update(f),s.set(f,d)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),s.get(c)!==d&&(e.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,n.ARRAY_BUFFER),s.set(c,d))),c.isSkinnedMesh){const m=c.skeleton;s.get(m)!==d&&(m.update(),s.set(m,d))}return f}function o(){s=new WeakMap}function l(c){const d=c.target;d.removeEventListener("dispose",l),i.releaseStatesOfObject(d),e.remove(d.instanceMatrix),d.instanceColor!==null&&e.remove(d.instanceColor)}return{update:a,dispose:o}}const gb={[Wf]:"LINEAR_TONE_MAPPING",[Zf]:"REINHARD_TONE_MAPPING",[Xf]:"CINEON_TONE_MAPPING",[Yf]:"ACES_FILMIC_TONE_MAPPING",[jf]:"AGX_TONE_MAPPING",[Kf]:"NEUTRAL_TONE_MAPPING",[qf]:"CUSTOM_TONE_MAPPING"};function _b(n,t,e,i,r){const s=new Hi(t,e,{type:n,depthBuffer:i,stencilBuffer:r}),a=new Hi(t,e,{type:dr,depthBuffer:!1,stencilBuffer:!1}),o=new pr;o.setAttribute("position",new ur([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new ur([0,2,0,0,2,0],2));const l=new hy({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
